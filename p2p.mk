...
P2P_DEPLOYMENT_REGISTRY_FAST_FEEDBACK ?= $(if $(filter $(P2P_REGISTRY),$(P2P_DEPLOYMENT_REGISTRY)),$(P2P_REGISTRY_FAST_FEEDBACK),$(P2P_DEPLOYMENT_REGISTRY)/$(P2P_REGISTRY_FAST_FEEDBACK_PATH))
P2P_DEPLOYMENT_REGISTRY_EXTENDED_TEST ?= $(if $(filter $(P2P_REGISTRY),$(P2P_DEPLOYMENT_REGISTRY)),$(P2P_REGISTRY_EXTENDED_TEST),$(P2P_DEPLOYMENT_REGISTRY)/$(P2P_REGISTRY_EXTENDED_TEST_PATH))
P2P_DEPLOYMENT_REGISTRY_PROD ?= $(if $(filter $(P2P_REGISTRY),$(P2P_DEPLOYMENT_REGISTRY)),$(P2P_REGISTRY_PROD),$(P2P_DEPLOYMENT_REGISTRY)/$(P2P_REGISTRY_PROD_PATH))
