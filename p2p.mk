...
ifeq ($(origin P2P_DEPLOYMENT_REGISTRY),undefined)
P2P_DEPLOYMENT_REGISTRY_FAST_FEEDBACK ?= $(P2P_REGISTRY_FAST_FEEDBACK)
P2P_DEPLOYMENT_REGISTRY_EXTENDED_TEST ?= $(P2P_REGISTRY_EXTENDED_TEST)
P2P_DEPLOYMENT_REGISTRY_PROD ?= $(P2P_REGISTRY_PROD)
else
