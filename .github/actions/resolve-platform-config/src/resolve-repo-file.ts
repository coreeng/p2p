...
export function resolveRepoFile(filePath: string, environment: string): EnvironmentConfig {
  ...
  if (!envConfig) {
    throw new ConfigError(`Environment '${environment}' not found in '${filePath}'`);
  }
